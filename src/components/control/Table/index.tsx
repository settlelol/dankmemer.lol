...
export default function Table({ instance, minWidth }: Props) {
	return (
		<>
			<div
				className="relative mt-4 w-full text-neutral-600 dark:text-neutral-300"
							...
							return (
								<div
									...
									className={clsx(
										...
										header.column.id !== "select_boxes" &&
											!header.column.id.startsWith("ng_") &&
											"grow"
									)}
									{...(sortable && {
