...
export default function ControlPanelContainer({
	...
	return (
		<>
			...
			<div
				className={clsx(
					"fixed top-0 right-0 h-full w-1/5 min-w-[330px] max-w-5xl resize-x overflow-auto bg-neutral-100 py-10 px-8 transition-transform duration-300 dark:bg-dark-100",
